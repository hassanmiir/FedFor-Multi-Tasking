...
def create_lstm_attention_model(input_shape):
    ...
    flatten = tf.keras.layers.Flatten()(attention_out)
    dense = Dense(50, activation='relu')(flatten)
    dropout = Dropout(0.2)(dense)
    outputs = Dense(1, activation='sigmoid')(dropout)  # Use 'softmax' for multi-class
...
if __name__ == "__main__":
    ...
    model = create_lstm_attention_model((X_train.shape[1], 1))
